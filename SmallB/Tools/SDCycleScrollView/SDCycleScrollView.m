...
@property (nonatomic, weak) XHPageControl *pageControl;
...
- (void)setCurrentPageDotColor:(UIColor *)currentPageDotColor
{
    ...
    }else if ([self.pageControl isKindOfClass:[XHPageControl class]]) {
        XHPageControl *pageControl = (XHPageControl *)_pageControl;
...
- (void)setupPageControl
{
    ...
    switch (self.pageControlStyle) {
        ...
        {
            XHPageControl *pageControl = [[XHPageControl alloc] init];
