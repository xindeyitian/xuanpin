...
#import "HDKeyChainManager.h"
NSString * const KEY_UUID_INSTEAD = @"com.controlfuture.life";
@implementation HDKeyChainManager


+ (NSString *)getDeviceIDInKeychain
{
    NSString *getUDIDInKeychain = (NSString *)[HDKeyChainManager load:KEY_UUID_INSTEAD];
...
//        NSLog(@"\n \n \n ______重新存储uuid __________\n \n \n %@",result);
        [HDKeyChainManager save:KEY_UUID_INSTEAD data:result];
        getUDIDInKeychain = (NSString *)[HDKeyChainManager load:KEY_UUID_INSTEAD];
    }
