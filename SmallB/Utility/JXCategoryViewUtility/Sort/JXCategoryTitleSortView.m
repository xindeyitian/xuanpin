...
- (void)refreshDataSource {
    ...
    for (int i = 0; i < self.titles.count; i++) {
        ...
        cellModel.titleFont = DEFAULT_FONT_R(16);
        cellModel.titleSelectedFont = DEFAULT_FONT_R(18);
        cellModel.titleLabelNormalZoomScale = 1;
        cellModel.titleLabelCurrentZoomScale = 1;
        cellModel.titleLabelSelectedZoomScale = 1;
