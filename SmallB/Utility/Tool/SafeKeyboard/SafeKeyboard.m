...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.item == 11)
    {
        ...
        cell.cellImageView.backgroundColor = KBGColor;
    ...
    else
    {
        ...
        if (indexPath.item == 9) {
            cell.cellTextLabel.backgroundColor = KBGColor;
        }else{
            cell.cellTextLabel.backgroundColor = KWhiteBGColor;
        }
        return cell;
    }
}
...
-(void)setupCell
{
    ...
    self.cellTextLabel.font = DEFAULT_FONT_M(24);
