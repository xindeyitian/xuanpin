...
- (void)creatSubViews{
    ...
    BaseButton *btn = [BaseButton CreateBaseButtonTitle:@"查看更多评价" Target:self Action:@selector(btnClick) Font:DEFAULT_FONT_R(13) BackgroundColor:UIColor.clearColor Color:KBlack333TextColor Frame:CGRectMake(0, 6, 125, 40) Alignment:NSTextAlignmentCenter Tag:3];
