...
- (void)viewDidLoad{
    ...
    BaseButton *cancel = [BaseButton CreateBaseButtonTitle:@"我知道啦" Target:self Action:@selector(btnClick) Font:DEFAULT_FONT_M(15) BackgroundColor:UIColor.whiteColor Color:KMaintextColor Frame:CGRectMake(0, 0, 0, 0) Alignment:NSTextAlignmentCenter Tag:22];
