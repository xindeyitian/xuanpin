//
//  myOrderListContentViewController.m
//  SmallB
//
...
@interface myOrderListContentViewController ()<JXCategoryViewDelegate,UITableViewDelegate,UITableViewDataSource,UICollectionViewDelegate,UICollectionViewDataSource,LMJVerticalFlowLayoutDelegate>
{
    NSInteger _index;
}
...
@implementation myOrderListContentViewController
...
- (void)viewDidLoad {
    ...
    [self.homeTable registerClass:[myOrderListContentTableViewCell class] forCellReuseIdentifier:[myOrderListContentTableViewCell description]];
}
