...
//    UIImageView *logoImage = [[UIImageView alloc]initWithImage:IMAGE_NAMED(@"my_share_bottom_logo")];
//    [codeImage addSubview:logoImage];
//    [logoImage mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.width.height.mas_equalTo(28*KScreenW_Ratio);
//        make.centerY.equalTo(codeImage.mas_centerY);
//        make.centerX.equalTo(codeImage.mas_centerX);
//    }];
    ...
    UILabel *codeTitle = [UILabel creatLabelWithTitle:@"邀请码：876567" textColor:KBlack333TextColor textAlignment:NSTextAlignmentLeft font:DEFAULT_FONT_R(15)];
