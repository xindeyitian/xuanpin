//
//  ApplySupplierUndereviewAlertViewController.m
//  SmallB
//
...
@interface ApplySupplierUndereviewAlertViewController ()

@end

@implementation ApplySupplierUndereviewAlertViewController
...
- (void)viewDidLoad {
    ...
    UILabel *title = [UILabel creatLabelWithTitle:@"供应商申请正在审核中，请等待审核！" textColor:KBlack333TextColor textAlignment:NSTextAlignmentCenter font:DEFAULT_FONT_M(17)];
